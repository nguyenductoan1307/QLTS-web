  ...
  function node_modulesAngularCommonLocalesFaJs(module, exports, __webpack_require__) {
    ...
    */
    ...
    (function (factory) {
      ...
      exports["default"] = ['fa', [['ق', 'ب'], ['ق.ظ.', 'ب.ظ.'], ["\u0642\u0628\u0644\u200C\u0627\u0632\u0638\u0647\u0631", 'بعدازظهر']], u, [['ی', 'د', 'س', 'چ', 'پ', 'ج', 'ش'], ['یکشنبه', 'دوشنبه', "\u0633\u0647\u200C\u0634\u0646\u0628\u0647", 'چهارشنبه', 'پنجشنبه', 'جمعه', 'شنبه'], u, ['۱ش', '۲ش', '۳ش', '۴ش', '۵ش', 'ج', 'ش']], u, [['ژ', 'ف', 'م', 'آ', 'م', 'ژ', 'ژ', 'ا', 'س', 'ا', 'ن', 'د'], ['ژانویهٔ', 'فوریهٔ', 'مارس', 'آوریل', 'مهٔ', 'ژوئن', 'ژوئیهٔ', 'اوت', 'سپتامبر', 'اکتبر', 'نوامبر', 'دسامبر'], u], [['ژ', 'ف', 'م', 'آ', 'م', 'ژ', 'ژ', 'ا', 'س', 'ا', 'ن', 'د'], ['ژانویه', 'فوریه', 'مارس', 'آوریل', 'مه', 'ژوئن', 'ژوئیه', 'اوت', 'سپتامبر', 'اکتبر', 'نوامبر', 'دسامبر'], u], [['ق', 'م'], ['ق.م.', 'م.'], ['قبل از میلاد', 'میلادی']], 6, [5, 5], ['y/M/d', 'd MMM y', 'd MMMM y', 'EEEE d MMMM y'], ['H:mm', 'H:mm:ss', 'H:mm:ss (z)', 'H:mm:ss (zzzz)'], ["{1}\u060C\u200F {0}", u, '{1}، ساعت {0}', u], ['.', ',', ';', '%', "\u200E+", "\u200E\u2212", 'E', '×', '‰', '∞', 'ناعدد', ':'], ['#,##0.###', '#,##0%', "\u200E\xA4\xA0#,##0.00", '#E0'], 'IRR', 'ریال', 'ریال ایران', {
        'AFN': ['؋'],
        'CAD': ['$CA', '$'],
        'CNY': ['¥CN', '¥'],
        'HKD': ['$HK', '$'],
...
//# sourceMappingURL=774-es5.js.map