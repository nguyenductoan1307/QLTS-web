...
@Component({
  selector: 'app-them-tai-san-sua-chua-bao-duong',
  templateUrl: './them-tai-san-sua-chua-bao-duong.component.html',
  styleUrls: ['./them-tai-san-sua-chua-bao-duong.component.scss'],
  animations: [appModuleAnimation()],
})
export class ThemTaiSanSuaChuaBaoDuongComponent extends AppComponentBase implements OnInit, OnDestroy {
  ...
  arrTaiSanCheckedFromParent: ViewTaiSanSuaChuaBaoDuong[] = [];
  @Output() arrTaiSanChecked: ViewTaiSanSuaChuaBaoDuong[] = [];
