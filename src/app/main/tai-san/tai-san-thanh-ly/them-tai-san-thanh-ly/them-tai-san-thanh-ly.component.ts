...
import { LookupTableDto, LookupTableServiceProxy, NhaCungCapGetAllInputDto, ViewTaiSanThanhLy, ViewTaiSan, TaiSanThanhLyServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
  selector: 'app-them-tai-san-thanh-ly',
  templateUrl: './them-tai-san-thanh-ly.component.html',
  styleUrls: ['./them-tai-san-thanh-ly.component.scss'],
  animations: [appModuleAnimation()],
})
export class ThemTaiSanThanhLyComponent extends AppComponentBase implements OnInit, OnDestroy {
  ...
  arrTaiSanCheckedFromParent: ViewTaiSanThanhLy[] = [];
  @Output() arrTaiSanChecked: ViewTaiSanThanhLy[] = [];
