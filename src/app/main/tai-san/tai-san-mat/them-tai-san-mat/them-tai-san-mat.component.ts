...
import { LookupTableDto, LookupTableServiceProxy, NhaCungCapGetAllInputDto, ViewTaiSanMat, ViewTaiSan, TaiSanMatServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
  selector: 'app-them-tai-san-mat',
  templateUrl: './them-tai-san-mat.component.html',
  styleUrls: ['./them-tai-san-mat.component.scss'],
  animations: [appModuleAnimation()],
})
export class ThemTaiSanMatComponent extends AppComponentBase implements OnInit, OnDestroy {
  ...
  arrTaiSanCheckedFromParent: ViewTaiSanMat[] = [];
  @Output() arrTaiSanChecked: ViewTaiSanMat[] = [];
