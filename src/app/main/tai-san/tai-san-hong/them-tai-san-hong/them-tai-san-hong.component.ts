...
import { LookupTableDto, LookupTableServiceProxy, NhaCungCapGetAllInputDto, ViewTaiSanHong, ViewTaiSan, TaiSanHongServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
  selector: 'app-them-tai-san-hong',
  templateUrl: './them-tai-san-hong.component.html',
  styleUrls: ['./them-tai-san-hong.component.scss'],
  animations: [appModuleAnimation()],
})
export class ThemTaiSanHongComponent extends AppComponentBase implements OnInit, OnDestroy {
  ...
  arrTaiSanCheckedFromParent: ViewTaiSanHong[] = [];
  @Output() arrTaiSanChecked: ViewTaiSanHong[] = [];
